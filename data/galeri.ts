...
export const galeri: FotoGaleri[] = [
  { id: '1', caption: 'Penyambutan di Balai Desa Kabuaran', kategori: 'Kegiatan', src: '/images/galeri/placeholder-1.jpg' },
  { id: '2', caption: 'Taman baca keliling bersama anak-anak', kategori: 'Pendidikan', src: '/images/galeri/placeholder-2.jpg' },
